                  ...
                  <tr key={quiz.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Link to={`/quizzes/${quiz.id}/preview`} className="text-indigo-600 hover:text-indigo-800 text-sm">Preview</Link>
                        {isInstructor && (
                          <>
                            <Link to={`/quizzes/${quiz.id}/edit`} className="text-blue-600 hover:text-blue-800 text-sm">Edit</Link>
                          </>
                        )}
                        {quiz.status === 'published' && !isInstructor && (
                          <Link to={`/quizzes/${quiz.id}/take`} className="bg-green-600 text-white px-3 py-1 rounded text-sm hover:bg-green-700">Take</Link>
                        )}
                      </div>
                    </td>
                  </tr>
