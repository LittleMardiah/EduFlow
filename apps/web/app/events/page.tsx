...
import type { Event, EventStatus } from '@/app/types/event';
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/events/create" className="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700 font-medium">
          + Create Event
        </Link>
      </div>
                ...
                {events.map((event) => (
                  <tr key={event.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link href={`/events/${event.id}/participants`} className="text-indigo-600 hover:text-indigo-800 text-sm">
                        Participants
                      </Link>
                    </td>
                  </tr>
