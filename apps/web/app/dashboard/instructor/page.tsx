      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/quizzes/create" className="bg-indigo-600 text-white px-3 py-1 rounded text-sm hover:bg-indigo-700">
              + Create Quiz
            </Link>
          </div>
          {quizzes.length === 0 ? (
            ...
            <div className="space-y-2">
              {quizzes.map((quiz) => (
                <div key={quiz.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <Link href={`/quizzes/${quiz.id}/edit`} className="text-indigo-600 hover:text-indigo-800 text-sm">
                    Edit
                  </Link>
                </div>
              ))}
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/events/create" className="bg-indigo-600 text-white px-3 py-1 rounded text-sm hover:bg-indigo-700">
              + Create Event
            </Link>
          </div>
          {events.length === 0 ? (
