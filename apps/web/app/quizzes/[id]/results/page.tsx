...
import { submissionApi } from '@/app/lib/apis/submission.api';
import { ResultsBreakdown } from '@/app/components/quiz/ResultsBreakdown';
import type { SubmissionResult } from '@/app/types/submission';
  ...
  if (error || !result) {
    return (
      <div className="text-center py-12">
        ...
        <Link href="/quizzes" className="text-indigo-600 hover:underline">Back to Quizzes</Link>
      </div>
    );
  }
