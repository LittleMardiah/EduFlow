...
echo "=========================================="
echo "  FIX RELATIONS - MANUAL PRECISE        "
echo "=========================================="
echo ""
...
echo "--- 2. FIX organization RELATION DI EVENT ---"
...
echo "✅ organization relation fixed (added 'OrganizationEvents')"
echo ""

echo "--- 3. FIX auditLogs RELATION DI EVENT ---"
sed -i 's/auditLogs         AuditLog\[\]/auditLogs         AuditLog[] @relation("EventAuditLogs")/' prisma/schema.prisma
echo "✅ auditLogs relation fixed (added 'EventAuditLogs')"
echo ""
