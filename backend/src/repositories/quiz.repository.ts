...
export const softDeleteQuiz = deleteQuiz; // alias for soft delete
export const getQuizVersions = async (quizId: string) => {
  // TODO: implement quiz versions
  return [];
};
