...
echo "=========================================="
echo "   FIX listQuestionsHandler              "
echo "=========================================="
echo ""

echo "--- 1. BACKUP ---"
cp src/controllers/question.controller.ts src/controllers/question.controller.ts.bak
echo "✅ Backup created"
echo ""

echo "--- 2. UPDATE listQuestionsHandler ---"
...
export async function listQuestionsHandler(req: Request, res: Response) {
  try {
    // Cari quiz_id dari berbagai sumber
...
echo "✅ listQuestionsHandler updated (now checks all sources)"
echo ""
