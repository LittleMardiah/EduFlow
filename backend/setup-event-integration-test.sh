...
echo "=========================================="
echo "  SETUP EVENT INTEGRATION TEST           "
echo "=========================================="
echo ""
...
cat > tests/integration/events.test.ts <<'TEST_EOF'
...
echo "✅ tests/integration/events.test.ts created"
echo ""
...
npx jest tests/integration/events.test.ts 2>&1 | tail -60
