...
echo "=========================================="
echo "   FIX REGISTER DOUBLE WRAP              "
echo "=========================================="
echo ""

echo "--- 1. BACKUP ---"
cp src/controllers/auth.controller.ts src/controllers/auth.controller.ts.bak-double
echo "✅ Backup created"
echo ""

echo "--- 2. FIX registerHandler ---"
cat > src/controllers/auth.controller.ts <<'CTRL_EOF'
...
echo "✅ registerHandler fixed (no double wrap)"
echo ""
