...
echo "=========================================="
echo "   FIX RESPONSE FORMAT - SUBMISSION TEST "
echo "=========================================="
echo ""

echo "--- 1. BACKUP auth.service.ts ---"
cp src/services/auth.service.ts src/services/auth.service.ts.bak5
echo "✅ Backup created"
echo ""

echo "--- 2. REWRITE auth.service.ts (dengan response wrapper) ---"
...
echo "✅ auth.service.ts updated with response wrapper"
echo ""
