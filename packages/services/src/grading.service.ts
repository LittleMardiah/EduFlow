import { prisma, SubmissionStatus, GradingStatus, QuestionType } from "@eduflow/database";
...
export class GradingService {
  async gradeSubmission(submission_id: string) {
    ...
    for (const answer of answers) {
      ...
      let gradingStatus: string = GradingStatus.auto_graded;
    ...
    const scorePercentage =
      totalPointsMax > 0 ? Math.round((totalPointsEarned / totalPointsMax) * 10000) / 100 : 0;
